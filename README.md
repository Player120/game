...
both dead), you lose. You can simply refresh the page to play again, no matter if you win or lose.
This is a very old project, so the code is very messy. You may encounter some bugs and weird ocurrances, and the damage, healing
and combat in general are extremely unbanlanced, as this was my first ever JavaScript project and one of my first ever programming
projects in general and I obviously didn't have any notion whatsoever about game designing, balancing, etc.
Looking back, I'm really happy about how much I've improved. :)
